...
class CentroDeportivo {
    ...
    void setNumeroSocios(int numero_socios) {
        this->numero_socios = numero_socios;
    }

    void setDisciplinaPrincipal(string disciplina_principal) {
        this->disciplina_principal = disciplina_principal;
    }
    ...
    int getNumeroSocios() const {
        return numero_socios;
    }

    string getDisciplinaPrincipal() const {
        return disciplina_principal;
    }
	bool operator<(const CentroDeportivo& otro) const {
    return nombre < otro.nombre;
	}
	CentroDeportivo operator=(CentroDeportivo& otro){
		nombre=otro.nombre;
		ciudad=otro.ciudad;
